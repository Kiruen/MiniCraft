...
namespace MiniCraft.Core.GUI
{
    ...
    /// </summary>
    public partial class MButton : GLControl
    {
        /// <summary>
        /// A rectangle control that displays an image.
        /// </summary>
        ...
        {
            var label = new MLabel(100, GUIAnchorStyles.None);
        ...
        {
            MButtonRenderer renderer = MButtonRenderer.Instance;
