...
namespace MiniCraft.Core.GUI
{
    public abstract partial class MControl
    {
        ...
        public virtual void InvokeEvent(MEventType eventType, GLEventArgs args)
        {
            switch (eventType)
            {
                case MEventType.KeyDown:
                    if (this.Focused)
                    {
                ...
                case MEventType.MouseMove:
                    ...
                    break;
                default:
                    throw new NotDealWithNewEnumItemException(typeof(MEventType));
            }
        }
