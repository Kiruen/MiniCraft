...
{
    /// <summary>
    /// children in <see cref="MControl"/>.
    /// </summary>
    [Editor(typeof(IListEditor<MControl>), typeof(UITypeEditor))]
    public class MCtrlChildren : IList<MControl>
    {
        internal readonly List<MControl> children = new List<MControl>();

        /// <summary>
        /// parent of this list's items.
        /// </summary>
        private readonly MControl parent;

        /// <summary>
        /// children in <paramref name="parent"/>.
        /// </summary>
        /// <param name="parent"></param>
        public MCtrlChildren(MControl parent)
        {
        ...
        public int IndexOf(MControl item)
        {
        ...
        public void Insert(int index, MControl item)
        {
        ...
        public MControl this[int index]
        {
            get
            {
        ...
        public void Add(MControl item)
        {
            ...
            MControl.LayoutAfterAddChild(item, this.parent);
            MControl.UpdateAbsLocation(item, this.parent);
        }
        ...
        public void AddRange(IEnumerable<MControl> items)
        {
        ...
        public void Clear()
        {
            MControl[] array = this.children.ToArray();
            this.children.Clear();
        ...
        public bool Contains(MControl item)
        {
        ...
        public void CopyTo(MControl[] array, int arrayIndex)
        {
        ...
        {
            get { return ((ICollection<MControl>)(this.children)).IsReadOnly; }
        }
        ...
        public bool Remove(MControl item)
        {
        ...
        public IEnumerator<MControl> GetEnumerator()
        {
